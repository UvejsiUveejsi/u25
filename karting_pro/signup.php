...
<section class="container mx-auto p-8 max-w-md">
    ...
    <form action="signuplogic.php" method="POST" class="space-y-4">
        ...
        <button type="submit" class="w-full px-4 py-2 bg-blue-600 dark:bg-red-600 text-white rounded">Create Account</button>
    </form>
